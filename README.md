...
Run `just setup-web-integration` once locally if Playwright needs to install Chromium. Set `MARGIN_SOSEIN_E2E_ENV_FILE` to use a different user-local config path.
